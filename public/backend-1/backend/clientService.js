(function() {
  ...
  function validateNifNie(value) {
    ...
    return (
      ...
      /^[A-Z][0-9]{7}[A-Z0-9]$/.test(normalized)
    );
  }
  ...
  function validatePhone(value) {
    ...
    return /^[+0-9\s\-()]{6,20}$/.test(normalized);
  }
  ...
  window.BackendClientService = service;
  window.ClientService = window.ClientService || service;

  console.log('BackendClientService loaded');
})();